      ...
      <div className="w-full max-w-sm px-8">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <input
            ...
            autoFocus
            className="w-full border border-gray-300 px-3 py-2.5 text-sm focus:outline-none focus:border-hc-teal focus:ring-1 focus:ring-hc-teal mb-1 rounded-sm"
          />
          {error && <p className="text-xs text-red-500 mb-3">{error}</p>}

          <button
            type="submit"
            className="mt-4 w-full bg-hc-teal hover:bg-hc-teal-700 text-white py-2.5 text-sm font-medium transition-colors rounded-sm"
          >
            Continue
          </button>
        </form>
